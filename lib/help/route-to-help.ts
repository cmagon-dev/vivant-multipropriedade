...
export const ROUTE_TO_HELP_SLUG: { route: string; slug: string }[] = [
  ...
  { route: "/admin/vivant-care/financeiro/lancar-cobrancas", slug: "financeiro-care" },
  { route: "/admin/vivant-care/financeiro/por-propriedade", slug: "financeiro-care" },
  { route: "/admin/vivant-care/financeiro/cobrancas", slug: "financeiro-care" },
